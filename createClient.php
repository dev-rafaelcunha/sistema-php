...
if ($_GET) {
    ...
    $erro = filter_input(INPUT_GET, 'success');

    if ($success = 200) {

        $success200 = 'Registro salvo!';
    }
}

if ($_POST) {

    Sql::allQuery('INSERT INTO cliente VALUES (DEFAULT, :CC, :SOCIAL, :FANTASIA, :NOME, :EMAIL, :TELEFONE)', [
    ...
    header('Location: createClient.php?success=200');
}
                    ...
                    <div class="card" style="height: 100vh;">
                        ...
                        <div class="card-header">
                            <ol class="breadcrumb my-2">
                                ...
                                <li class="breadcrumb-item active"><strong>Novo cliente</strong></li>
                            </ol>
                        </div>
                                    ...
                                    <div class="row mt-2 px-0 m-0 lead fs-6 border" style="background-color: #cff4fc;">
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" class="form-control shadow-none text-secondary"
                                                name="cc" autocomplete="off" required style="margin-top: -8px;">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control shadow-none text-secondary"
                                                name="social" autocomplete="off" required style="margin-top: -8px;">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label mt-1"><strong>Nome Fantasia</strong></label>
                                            <input type="text" class="form-control shadow-none text-secondary"
                                                name="fantasia" autocomplete="off" required style="margin-top: -8px;">
                                        </div>
