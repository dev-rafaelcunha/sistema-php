                    ...
                    <div class="card" style="height: 100vh;">
                        ...
                        <div class="card-header">
                            <ol class="breadcrumb my-2">
                                ...
                                <li class="breadcrumb-item active"><strong>Usuários</strong></li>
                            </ol>
                        </div>
                        ...
                        <div class="card-body">
                            <blockquote class="blockquote mb-0">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a href="createUser.php" type="button" class="btn btn-sm btn-primary">Novo</a>
                                    </div>
                                ...
                                <table class="table table-hover table-info mt-2">
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($getListUsers as $key => $value) : ?>

                                        <tr class="row p-0 m-0">
                                            <td class="col-sm"><a href="editUser.php?user=<?= $value['id'] ?>"
                                                    class="text-decoration-none text-dark fs-6 lead"><?= $value['nome'] ?>
                                                </a></td>
                                            <td class="col-sm"><a href="editUser.php?user=<?= $value['id'] ?>"
                                                    class="text-decoration-none text-dark fs-6 lead"><?= $value['email'] ?>
                                                </a></td>
                                            <td class="col-sm"><a href="editUser.php?user=<?= $value['id'] ?>"
